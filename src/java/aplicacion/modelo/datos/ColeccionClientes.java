...
public class ColeccionClientes implements Serializable {
    ...
    public static void llenarTabla() {
        ...
        getClientes().add(new Cliente(120, 154516, "Neo", "Smith", calendar.getTime(), correo, null));

        calendar.set(2012, 8, 11);
        correo = "correo2@gmail.com";

        getClientes().add(new Cliente(77, 23471, "Cersei", "Stark", calendar.getTime(), correo, null));
    }
